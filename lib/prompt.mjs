export function buildSystemPrompt() {
  return [
    ...
    "Descriptions should be one concise sentence and mention the real target count.",
...
export function buildUserPrompt(payload) {
  ...
  return JSON.stringify(
    {
      instruction: "Generate one quest board for the given player context. Use a diverse set of allowed_templates and vary target_count sensibly.",
